...
const NewTour = ({ title }) => {
      ...
      [category]: {
        ...
        seasons: [
          ...(prevState[category]?.seasons || []),
          {
            startDate: "",
            endDate: "",
            pricing: [{ price: "", rooms: "", person:1 }], // Default pricing
          },
        ],
      },
    }));
  ...
  const addPricingForSeason = (seasonIndex, category) => {
    setTourData((prevState) => {
      ...
      // Determine person number (start at 1 if empty, otherwise length + 1)
      const nextPersonNumber = updatedSeasons[seasonIndex].pricing.length > 0 
        ? updatedSeasons[seasonIndex].pricing.length + 1 
        : 1;
      ...
      updatedSeasons[seasonIndex].pricing.push({
        price: "",
        rooms: "",
        person: nextPersonNumber, // Ensure first entry starts from 1
      });
      ...
      <div className="formGroup">
        ...
        {tourData.deluxeDetails.itineraries.map((itinerary, index) => (
          <div key={index} className="itinerary">
            ...
            {itinerary.welcomeDrinks?.isAvailable && (
              <div className="siteseen-section">
                <h4>Welcome drink ( width: 800px , height: 350px) </h4>
