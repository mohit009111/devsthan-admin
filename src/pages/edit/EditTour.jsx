        ...
        <div className="standardDetails">
            ...
            <div className="formGroup">
                ...
                <ReactQuill
                    ...
                    onChange={(value) => handleFieldChange('highlights', value, 'standardDetails')}
            ...
            <div className="formGroup">
                ...
                <ReactQuill
                    ...
                    onChange={(value) => handleFieldChange('whatsIncluded', value, 'standardDetails')}
            ...
            <div className="formGroup">
                ...
                <ReactQuill
                    ...
                    onChange={(value) => handleFieldChange('whatsExcluded', value, 'standardDetails')}
                    ...
                    <div key={index} className="itinerary">
                        ...
                        <div className="photo-preview">
                            {tourData?.standardDetails?.itineraries[index].photos?.map((photo, photoIndex) => (
                                <div key={photoIndex} style={{ display: "inline-block", position: "relative", margin: "5px" }}>
                                    <img
                                        src={photo}
                                    ...
                                    <button
                                        ...
                                        onClick={() => {
                                            const updatedPhotos = itinerary.photos.filter((_, i) => i !== photoIndex);
                                            const updatedItineraries = [...tourData.standardDetails.itineraries];
                                            updatedItineraries[index] = { ...itinerary, photos: updatedPhotos };
                                            setTourData({
                                                ...tourData,
                                                standardDetails: { ...tourData.standardDetails, itineraries: updatedItineraries },
                                            });
                                        }}
                                    >
                                        ×
                                        ...
                                        itinerary.siteSeen.photos.map((photo, photoIndex) => (
                                            <div key={photoIndex} style={{ display: "inline-block", position: "relative", margin: "5px" }}>
                                                ...
                                                <button
                                                    ...
                                                    onClick={() => {
                                                        const updatedPhotos = itinerary.siteSeen.photos.filter((_, i) => i !== photoIndex);
                                                        handleItineraryChange(
                                                            index,
                                                            "siteSeen",
                        ...
                        {itinerary.welcomeDrinks?.isAvailable && (
                            <div className="siteseen-section">
                                ...
                                <input
                                    ...
                                    onChange={(e) =>
                                        handleItineraryChange(index, "welcomeDrinks", { ...itinerary.welcomeDrinks, name: e.target.value }, "standardDetails")
                                    }
                                />
                                ...
                                <textarea
                                    ...
                                    onChange={(e) =>
                                        handleItineraryChange(index, "welcomeDrinks", { ...itinerary.welcomeDrinks, description: e.target.value }, "standardDetails")
                                    }
                                ></textarea>
                                ...
                                <input
                                    ...
                                    onChange={(e) => {
                                        ...
                                        handleItineraryChange(
                                            index,
                                            "welcomeDrinks",
                                            { ...itinerary.welcomeDrinks, photos: [...(itinerary.welcomeDrinks.photos || []), ...files] },
                                            "standardDetails"
                                        );
                                    }}
                                />
        ...
        {itinerary.hotel.hotelImages.map((photo, photoIndex) => (
            <div key={photoIndex} className="photo-container">
                ...
                <button
                    ...
                    onClick={() => {
                        const updatedHotelImages = itinerary.hotel.hotelImages.filter((_, i) => i !== photoIndex);
                        const updatedItineraries = [...tourData.standardDetails.itineraries];
...
{itinerary.hotel.roomImages?.length > 0 && (
            ...
            <div key={photoIndex} className="photo-container">
                ...
                <button
                    ...
                    onClick={() => {
                        ...
                        const updatedRoomImages = itinerary.hotel.roomImages.filter((_, i) => i !== photoIndex);
                        const updatedItineraries = [...tourData.standardDetails.itineraries];
                        updatedItineraries[index] = {
                            ...itinerary,
                            hotel: {
    ...
    <div className="preview-photos">
        {itinerary.activity.photos.map((photo, photoIndex) => (
            <div key={photoIndex} className="photo-container" style={{ position: "relative", display: "inline-block", margin: "5px" }}>
                <img
                    src={photo}
                ...
                <button
                    ...
                    onClick={() => {
                        ...
                        const updatedActivityPhotos = itinerary.activity.photos.filter((_, i) => i !== photoIndex);
                        const updatedItineraries = [...tourData.standardDetails.itineraries];
                        updatedItineraries[index] = {
                            ...itinerary,
                            activity: {
            ...
            <div key={photoIndex} className="photo-container" style={{ position: "relative", display: "inline-block", margin: "5px" }}>
                ...
                <button
                    ...
                    onClick={() => {
                        ...
                        const updatedCarPhotos = itinerary.transportation.car.photos.filter((_, i) => i !== photoIndex);
                        const updatedItineraries = [...tourData.standardDetails.itineraries];
                        updatedItineraries[index] = {
                            ...itinerary,
                            transportation: {
        ...
        <div className="deluxeDetails">
            ...
            <div className="formGroup">
                ...
                <ReactQuill
                    ...
                    onChange={(value) => handleFieldChange('highlights', value, 'deluxeDetails')}
                    placeholder="Enter highlights"
                />
            </div>
            ...
            <div className="formGroup">
                ...
                <ReactQuill
                    ...
                    onChange={(value) => handleFieldChange('whatsIncluded', value, 'deluxeDetails')}
                    placeholder="Enter whatsIncluded"
                />
            </div>
            ...
            <div className="formGroup">
                ...
                <ReactQuill
                    ...
                    onChange={(value) => handleFieldChange('whatsExcluded', value, 'deluxeDetails')}
                    placeholder="Enter whatsExcluded"
                />
            </div>
        ...
        <div key={photoIndex} className="photo-container">
            ...
            <button
                ...
                onClick={() => {
                    ...
                    const updatedPhotos = tourData.deluxeDetails.itineraries[index].photos.filter((_, i) => i !== photoIndex);
                        ...
                        {itinerary.welcomeDrinks?.isAvailable && (
                            <div className="siteseen-section">
                                ...
                                <input
                                    ...
                                    value={itinerary.welcomeDrinks.name || ""}
                                    onChange={(e) =>
                                        handleItineraryChange(index, "welcomeDrinks", { ...itinerary.welcomeDrinks, name: e.target.value }, "deluxeDetails")
                                    }
                                />
                                ...
                                <textarea
                                    ...
                                    value={itinerary.welcomeDrinks.description || ""}
                                    onChange={(e) =>
                                        handleItineraryChange(index, "welcomeDrinks", { ...itinerary.welcomeDrinks, description: e.target.value }, "deluxeDetails")
                                    }
                                ></textarea>
        ...
        itinerary.welcomeDrinks.photos.map((photo, photoIndex) => (
            <div key={photoIndex} className="photo-container">
                ...
                <button
                    ...
                    onClick={() => {
                        // Remove the selected photo by filtering it out
                        const updatedPhotos = itinerary.welcomeDrinks.photos.filter((_, i) => i !== photoIndex);
                        const updatedItinerary = {
                            ...itinerary,
                            welcomeDrinks: {
                        ...
                        setTourData({
                            ...
                            standardDetails: {
                                ...tourData.standardDetails,
                                itineraries: tourData.standardDetails.itineraries.map((it, idx) => idx === index ? updatedItinerary : it),
                            },
                        });
                    }}
                >
...
<div className="preview-photos">
    {itinerary.siteSeen.photos && itinerary.siteSeen.photos.map((photo, photoIndex) => (
        <div key={photoIndex} className="photo-container">
            <img
                src={photo}
                alt={`Siteseen photo ${photoIndex + 1}`}
            ...
            <div key={photoIndex} className="photo-container">
                ...
                <button
                    ...
                    onClick={() => {
                        ...
                        const updatedPhotos = itinerary.hotel.hotelImages.filter((_, i) => i !== photoIndex);
                        const updatedItinerary = {
                            ...itinerary,
                            hotel: {
                                ...itinerary.hotel,
            ...
            <div key={photoIndex} className="photo-container">
                ...
                <button
                    ...
                    onClick={() => {
                        ...
                        const updatedPhotos = itinerary.hotel.roomImages.filter((_, i) => i !== photoIndex);
                        const updatedItinerary = {
                            ...itinerary,
                            hotel: {
                                ...itinerary.hotel,
                ...
                <div key={photoIndex} className="photo-container">
                    ...
                    <button
                        ...
                        onClick={() => {
                            ...
                            const updatedPhotos = itinerary.meals.breakfast.photos.filter((_, i) => i !== photoIndex);
                            const updatedItinerary = {
                                ...itinerary,
                                meals: {
                                    ...itinerary.meals,
            ...
            return (
                <div key={photoIndex} className="photo-container">
                    ...
                    <button
                        ...
                        onClick={() => {
                            // Remove the selected photo by filtering it out
                            const updatedPhotos = itinerary.meals.lunch.photos.filter((_, i) => i !== photoIndex);
                            const updatedItinerary = {
                                ...itinerary,
                                meals: {
                                    ...itinerary.meals,
            ...
            return (
                <div key={photoIndex} className="photo-container">
                    ...
                    <button
                        ...
                        onClick={() => {
                            // Remove the selected photo by filtering it out
                            const updatedPhotos = itinerary.meals.dinner.photos.filter((_, i) => i !== photoIndex);
                            const updatedItinerary = {
                                ...itinerary,
                                meals: {
                                    ...itinerary.meals,
                                    dinner: {
                                        ...
                                        photos: updatedPhotos, // Update the dinner photos array
                                    },
                                },
                            };
        ...
        {itinerary.activity.photos.map((photo, photoIndex) => (
            <div key={photoIndex} className="photo-container">
                ...
                <button
                    ...
                    onClick={() => {
                        // Remove the selected photo by filtering it out
                        const updatedPhotos = itinerary.activity.photos.filter((_, i) => i !== photoIndex);
                        const updatedItinerary = {
                            ...itinerary,
                            activity: {
                                ...itinerary.activity,
        ...
        {itinerary.transportation.car.photos.map((photo, photoIndex) => (
            <div key={photoIndex} className="photo-container" style={{ position: "relative", display: "inline-block", margin: "5px" }}>
                ...
                <button
                    ...
                    onClick={() => {
                        // Remove the selected photo by filtering it out
                        const updatedPhotos = itinerary.transportation.car.photos.filter((_, i) => i !== photoIndex);
                        const updatedItinerary = {
                            ...itinerary,
                            transportation: {
                                ...itinerary.transportation,
    ...
    {(itinerary.transportation.bus.photos || []).map((photo, photoIndex) => (
        <div key={photoIndex} className="photo-container" style={{ position: "relative", display: "inline-block", margin: "5px" }}>
            ...
            <button
                ...
                onClick={() => {
                    // Remove the selected photo by filtering it out
                    const updatedPhotos = itinerary.transportation.bus.photos.filter((_, i) => i !== photoIndex);
                    const updatedItinerary = { 
                        ...itinerary, 
                        transportation: {
                            ...itinerary.transportation,
    ...
    {(itinerary.transportation.train.photos || []).map((photo, photoIndex) => (
        <div key={photoIndex} className="photo-container" style={{ position: "relative", display: "inline-block", margin: "5px" }}>
            ...
            <button
                ...
                onClick={() => {
                    // Remove the selected photo by filtering it out
                    const updatedPhotos = itinerary.transportation.train.photos.filter((_, i) => i !== photoIndex);
                    const updatedItinerary = { 
                        ...itinerary, 
                        transportation: {
                            ...itinerary.transportation,
    ...
    {(itinerary.transportation.flight.photos || []).map((photo, photoIndex) => (
        <div key={photoIndex} className="photo-container" style={{ position: "relative", display: "inline-block", margin: "5px" }}>
            ...
            <button
                ...
                onClick={() => {
                    // Remove the selected photo by filtering it out
                    const updatedPhotos = itinerary.transportation.flight.photos.filter((_, i) => i !== photoIndex);
                    const updatedItinerary = { 
                        ...itinerary, 
                        transportation: {
                            ...itinerary.transportation,
    ...
    {(itinerary.transportation.chopper.photos || []).map((photo, photoIndex) => (
        <div key={photoIndex} className="photo-container" style={{ position: "relative", display: "inline-block", margin: "5px" }}>
            ...
            <button
                ...
                onClick={() => {
                    // Remove the selected photo by filtering it out
                    const updatedPhotos = itinerary.transportation.chopper.photos.filter((_, i) => i !== photoIndex);
                    const updatedItinerary = { 
                        ...itinerary, 
                        transportation: {
                            ...itinerary.transportation,
        ...
        <div className="premiumDetails">
            ...
            <div className="formGroup">
                ...
                <ReactQuill
                    ...
                    onChange={(value) => handleFieldChange('highlights', value, 'premiumDetails')}
                    placeholder="Enter highlights"
                />
            </div>
            ...
            <div className="formGroup">
                ...
                <ReactQuill
                    ...
                    onChange={(value) => handleFieldChange('whatsIncluded', value, 'premiumDetails')}
                    placeholder="Enter whatsIncluded"
                />
            </div>
            ...
            <div className="formGroup">
                ...
                <ReactQuill
                    ...
                    onChange={(value) => handleFieldChange('whatsExcluded', value, 'premiumDetails')}
                    placeholder="Enter whatsExcluded"
                />
            </div>
    ...
    {tourData.premiumDetails.itineraries[index].photos?.map((photo, photoIndex) => (
        <div key={photoIndex} className="photo-container" style={{ position: "relative", display: "inline-block", margin: "5px" }}>
            ...
            <button
                ...
                onClick={() => {
                    // Remove the selected photo by filtering it out
                    const updatedPhotos = tourData.premiumDetails.itineraries[index].photos.filter((_, i) => i !== photoIndex);
                    ...
                    setTourData({
                        ...tourData,
                        premiumDetails: { ...tourData.premiumDetails, itineraries: updatedItineraries },
                    });
                }}
            >
                &times;
                        ...
                        {itinerary.welcomeDrinks?.isAvailable && (
                            <div className="siteseen-section">
                                ...
                                <input
                                    ...
                                    value={itinerary.welcomeDrinks.name || ""}
                                    onChange={(e) =>
                                        handleItineraryChange(index, "welcomeDrinks", { ...itinerary.welcomeDrinks, name: e.target.value }, "premiumDetails")
                                    }
                                />
                                ...
                                <textarea
                                    ...
                                    value={itinerary.welcomeDrinks.description || ""}
                                    onChange={(e) =>
                                        handleItineraryChange(index, "welcomeDrinks", { ...itinerary.welcomeDrinks, description: e.target.value }, "premiumDetails")
                                    }
                                ></textarea>
                ...
                &times;
                        ...
                        {itinerary.tourManager?.isAvailable && (
                            <div className="tour-manager-section">
                                ...
                                {/* Preview Tour Manager Photo */}
                                {itinerary.tourManager?.photo && (
    <div className="preview-tour-manager-photo" style={{ position: "relative", display: "inline-block", margin: "5px" }}>
        <img
            src={itinerary.tourManager.photo}
            alt="Tour Manager"
            width="100"
        ...
        itinerary.siteSeen.photos.map((photo, photoIndex) => (
            <div key={photoIndex} className="photo-container" style={{ position: "relative", display: "inline-block", margin: "5px" }}>
                ...
                <button
                    ...
                    onClick={() => {
                        // Remove the selected photo from the siteSeen.photos array
                        const updatedPhotos = itinerary.siteSeen.photos.filter((_, i) => i !== photoIndex);
                        const updatedItineraries = [...tourData.standardDetails.itineraries];
                        updatedItineraries[index] = {
                            ...itinerary,
                            siteSeen: {
                                ...itinerary.siteSeen,
                                photos: updatedPhotos, // Update the photos array in siteSeen
                            },
                        };
                        setTourData({
                            ...tourData,
        ...
        {itinerary.activity.photos.map((photo, photoIndex) => (
            <div key={photoIndex} className="photo-container" style={{ position: "relative", display: "inline-block", margin: "5px" }}>
                ...
                <button
                    ...
                    onClick={() => {
                        // Filter out the selected photo to delete
                        const updatedPhotos = itinerary.activity.photos.filter((_, i) => i !== photoIndex);
                        const updatedItineraries = [...tourData.standardDetails.itineraries];
                        updatedItineraries[index] = {
                            ...itinerary,
                            activity: {
                                ...itinerary.activity,
                                photos: updatedPhotos, // Update activity photos
                            },
                        };
                        setTourData({
                            ...tourData,
        ...
        >
            ...
            <button
                ...
                onClick={() => {
                    ...
                    const updatedBusPhotos = itinerary.transportation.bus.photos.filter((_, i) => i !== photoIndex);
                    const updatedItineraries = [...tourData.standardDetails.itineraries];
                    updatedItineraries[index] = {
                        ...itinerary,
                        transportation: {
        ...
        >
            ...
            <button
                ...
                onClick={() => {
                    ...
                    const updatedTrainPhotos = itinerary.transportation.train.photos.filter((_, i) => i !== photoIndex);
                    const updatedItineraries = [...tourData.standardDetails.itineraries];
                    updatedItineraries[index] = {
                        ...itinerary,
                        transportation: {
        ...
        >
            ...
            <button
                ...
                onClick={() => {
                    ...
                    const updatedFlightPhotos = itinerary.transportation.flight.photos.filter((_, i) => i !== photoIndex);
                    const updatedItineraries = [...tourData.standardDetails.itineraries];
                    updatedItineraries[index] = {
                        ...itinerary,
                        transportation: {
        ...
        >
            ...
            <button
                ...
                onClick={() => {
                    ...
                    const updatedChopperPhotos = itinerary.transportation.chopper.photos.filter((_, i) => i !== photoIndex);
                    const updatedItineraries = [...tourData.standardDetails.itineraries];
                    updatedItineraries[index] = {
                        ...itinerary,
                        transportation: {
                    ...
                    <form onSubmit={handleSubmit} >
                        ...
                        <div className="formGroup">
                            ...
                            <ReactQuill
                                ...
                                onChange={(value) => handleQuillChange(value, "termsAndConditions")}
                        ...
                        <div className="formGroup">
                            ...
                            <ReactQuill
                                ...
                                onChange={(value) => handleQuillChange(value, "departureDetails")}
                        ...
                        <div className="formGroup">
                            ...
                            <ReactQuill
                                ...
                                onChange={(value) => handleQuillChange(value, "knowBeforeYouGo")}
                        ...
                        <div className="formGroup" style={{ position: "relative" }}>
                            ...
                            <div>
                                ...
                                >
                                    ...
                                    {Array.from(new Set(
                                        (destinations || []).map((d) => d.state?.label?.toLowerCase() || "")
                                    )).map((label, index) => (
                                        label && (
