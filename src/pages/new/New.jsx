    ...
    try {
      ...
      const uploadImagesForField = async (photos = []) => {
        ...
        return await Promise.all(
          photos.map(async (photo) => (photo ? await uploadImageToS3(photo) : null))
        );
      };
      ...
      const appendImagesToItinerary = async (itinerary) => {
        ...
        if (itinerary.welcomeDrinks?.photos) {
          itinerary.welcomeDrinks.photos = await uploadImagesForField(itinerary.welcomeDrinks.photos);
                                            ...
                                            <div key={photoIndex} className="photo-container">
                                                ...
                                                <button
                                                    ...
                                                    onClick={() => {
                                                        ...
                                                        setTourData({
                                                            ...tourData,
                                                            deluxeDetails: { ...tourData.deluxeDetails, itineraries: updatedItineraries },
                                                        });
                                                    }}
                                                >
                                                    &times;
            ...
            <div className="formGroup" style={{ position: "relative" }}>
              ...
              <div>
                ...
                >
                  ...
                  {Array.from(new Set(
                    (destinations || []).map((d) => d.country?.label?.toLowerCase() || "")
                  )).map((label, index) => (
                ...
                >
                  ...
                  {Array.from(new Set(
                    (destinations || []).map((d) => d.city?.label?.toLowerCase() || "")
                  )).map((label, index) => (
                    label && (
                      <option key={index} value={label}>
                        {label}
