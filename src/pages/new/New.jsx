...
const NewTour = ({ title }) => {
  ...
  // 🟢 Add a new season
  const addSeason = (category) => {
    setTourData((prevState) => ({
      ...prevState,
      [category]: {
        ...prevState[category],
        seasons: [
          ...(prevState[category]?.seasons || []),
          {
            startDate: "",
            endDate: "",
            pricing: [{ price: "", rooms: "", person: "" }], // Default pricing
          },
        ],
      },
    }));
  ...
  // 🟢 Remove a season
  const removeSeason = (seasonIndex, category) => {
    setTourData((prevState) => {
      const updatedSeasons = [...prevState[category].seasons];
  ...
  // 🟢 Update season start/end date
  const handleSeasonChange = (seasonIndex, field, value, category) => {
    setTourData((prevState) => {
      const updatedSeasons = [...prevState[category].seasons];
  ...
  // 🟢 Add pricing inside a season
  const addPricingForSeason = (seasonIndex, category) => {
    setTourData((prevState) => {
      const updatedSeasons = [...prevState[category].seasons];

      // Ensure pricing array exists
      if (!updatedSeasons[seasonIndex].pricing) {
        updatedSeasons[seasonIndex].pricing = [];
      }

      // Calculate the next person number (length + 1)
      const nextPersonNumber = updatedSeasons[seasonIndex].pricing.length + 1;

      // Add new pricing entry
      updatedSeasons[seasonIndex].pricing.push({
        price: "",
        rooms: "",
        person: nextPersonNumber, // Auto-increment person field
      });
  ...
  // 🟢 Remove pricing from a season
  const removePricingForSeason = (seasonIndex, priceIndex, category) => {
    setTourData((prevState) => {
      const updatedSeasons = [...prevState[category].seasons];
      updatedSeasons[seasonIndex].pricing.splice(priceIndex, 1);
  ...
  // 🟢 Update pricing inside a season
  const handlePricingChange = (seasonIndex, priceIndex, field, value, category) => {
    setTourData((prevState) => {
      const updatedSeasons = [...prevState[category].seasons];
      updatedSeasons[seasonIndex].pricing[priceIndex][field] = value;
  ...
  const renderStandardDetails = () => (
    <div className="standardDetails">
      ...
      <div className="formGroup">
        <label>Seasons</label>
        {tourData.standardDetails?.seasons?.map((season, seasonIndex) => (
          <div key={seasonIndex} className="seasonBlock">
            <input
              type="text"
              value={season.seasonName}
              onChange={(e) => handleSeasonChange(seasonIndex, "seasonName", e.target.value, "standardDetails")}
            ...
            <input
              ...
              onChange={(e) => handleSeasonChange(seasonIndex, "startDate", e.target.value, "standardDetails")}
              placeholder="Season Start Date"
            />
            <input
              type="date"
              value={season.endDate}
              onChange={(e) => handleSeasonChange(seasonIndex, "endDate", e.target.value, "standardDetails")}
              placeholder="Season End Date"
            />

            {/* Pricing for this season */}
            <label>Pricing</label>
            {season.pricing.map((priceObj, priceIndex) => (
              <div key={priceIndex}>
                <input
                  type="number"
                  value={priceObj.price}
                  onChange={(e) => handlePricingChange(seasonIndex, priceIndex, "price", e.target.value, "standardDetails")}
                  placeholder="Price per person"
                />
                <input
                  type="number"
                  value={priceObj.rooms}
                  onChange={(e) => handlePricingChange(seasonIndex, priceIndex, "rooms", e.target.value, "standardDetails")}
                  placeholder="Number of rooms"
                />
                <button
                  type="button"
                  onClick={() => removePricingForSeason(seasonIndex, priceIndex, "standardDetails")}
                >
                  Remove Pricing
                </button>
              </div>
            ...
            <button type="button" onClick={() => addPricingForSeason(seasonIndex, "standardDetails")}>
              Add Pricing
            </button>

            <button type="button" onClick={() => removeSeason(seasonIndex, "standardDetails")}>
              Remove Season
            </button>
          </div>
        ))}

        <button type="button" onClick={() => addSeason("standardDetails")}>
          Add Season
        </button>
      </div>
      ...
      <div className="formGroup">
        ...
        {tourData?.standardDetails?.itineraries?.map((itinerary, index) => (
          <div key={index} className="itinerary">
            ...
            <label>Itinerary Photos (width: 800px, height:350px)</label>
            <input
              type="file"
              multiple
              accept="image/*"
...
{console.log(itinerary.siteSeen)}
            ...
            {itinerary.welcomeDrinks?.isAvailable && (
              <div className="siteseen-section">
                ...
                {/* Siteseen Photos */}
                <label>Upload Welcome drinks Photos (width: 800px, height:350px)</label>
                <input
                  type="file"
                  multiple
                  onChange={(e) => {
            ...
            {itinerary.tourManager?.isAvailable && (
              <div className="tour-manager-section">
                ...
                {/* Tour Manager Photo */}
                <label>Upload Tour Manager Photo (width: 800px, height:350px)</label>
                <input
                  type="file"
                  onChange={(e) => {
            ...
            {itinerary.hotel.isIncluded && (
              <div className="hotel-details">
                ...
                <label>Hotel Images (width: 800px, height:350px)</label>
                <input
                  type="file"
                  multiple
                  accept="image/*"
                ...
                <label>Room Images (width: 800px, height:350px)</label>
                <input
                  type="file"
                  multiple
                  accept="image/*"
              ...
              <div className="meals-checkbox">
                ...
                {itinerary?.meals?.breakfast?.isAvailable == true && (
                  <div className="meal-details">
                    ...
                    <label>Breakfast Photos (width: 800px, height:350px)</label>
                    <input
                      type="file"
                      multiple
                      onChange={(e) =>
                ...
                {itinerary.meals.lunch.isAvailable == true && (
                  <div className="meal-details">
                    ...
                    />
                    <label>Lunch Photos (width: 800px, height:350px)</label>
                    <input
                      type="file"
                      multiple
                      onChange={(e) =>
                ...
                {itinerary.meals.dinner.isAvailable == true && (
                  <div className="meal-details">
                    ...
                    />
                    <label>Dinner Photos (width: 800px, height:350px)</label>
                    <input
                      type="file"
                      multiple
                      onChange={(e) =>
              ...
              <div className="transportation-section">
                ...
                {itinerary.transportation.car?.isIncluded && (
                  <div className="transportation-details">
                    ...
                    />
                    <label>Upload Car Photos (width: 800px, height:350px)</label>
                    <input
                      type="file"
                      multiple
                      accept="image/*"
                ...
                {itinerary.transportation.bus?.isIncluded && (
                  <div className="transportation-details">
                    ...
                    <label>Upload Bus Photos(width: 800px, height:350px)</label>
                    <input
                      type="file"
                      multiple
                      onChange={(e) =>
                ...
                {itinerary.transportation.train?.isIncluded && (
                  <div className="transportation-details">
                    ...
                    <label>Upload Train Photos (width: 800px, height:350px)</label>
                    <input
                      type="file"
                      multiple
                      onChange={(e) =>
                ...
                {itinerary.transportation.flight?.isIncluded && (
                  <div className="transportation-details">
                    ...
                    <label>Upload Flight Photos (width: 800px, height:350px)</label>
                    <input
                      type="file"
                      multiple
                      onChange={(e) =>
                ...
                {itinerary.transportation.chopper?.isIncluded && (
                  <div className="transportation-details">
                    ...
                    <label>Upload Chopper Photos (width: 800px, height:350px)</label>
                    <input
                      type="file"
                      multiple
                      onChange={(e) =>
  ...
  const renderDeluxeDetails = () => (
    <div className="deluxeDetails">
      ...
      <div className="formGroup">
        <label>Seasons</label>
        {tourData.deluxeDetails?.seasons?.map((season, seasonIndex) => (
          <div key={seasonIndex} className="seasonBlock">
            {/* Season Start & End Date */}
            <input
              type="text"
              value={season.seasonName}
              onChange={(e) => handleSeasonChange(seasonIndex, "seasonName", e.target.value, "deluxeDetails")}
              placeholder="Season Name"
            />
            <input
              type="date"
              value={season.startDate}
              onChange={(e) => handleSeasonChange(seasonIndex, "startDate", e.target.value, "deluxeDetails")}
              placeholder="Season Start Date"
            />
            <input
              type="date"
              value={season.endDate}
              onChange={(e) => handleSeasonChange(seasonIndex, "endDate", e.target.value, "deluxeDetails")}
              placeholder="Season End Date"
            />
            ...
            {season.pricing.map((priceObj, priceIndex) => (
              <div key={priceIndex}>
                <input
                  type="number"
                  value={priceObj.price}
                  onChange={(e) => handlePricingChange(seasonIndex, priceIndex, "price", e.target.value, "deluxeDetails")}
                  placeholder="Price per person"
                />
                <input
                  type="number"
                  value={priceObj.rooms}
                  onChange={(e) => handlePricingChange(seasonIndex, priceIndex, "rooms", e.target.value, "deluxeDetails")}
                  placeholder="Number of rooms"
                />
                <button
                  type="button"
                  onClick={() => removePricingForSeason(seasonIndex, priceIndex, "deluxeDetails")}
                >
                  Remove Pricing
                </button>
              </div>
            ...
            <button type="button" onClick={() => addPricingForSeason(seasonIndex, "deluxeDetails")}>
              Add Pricing
            </button>

            <button type="button" onClick={() => removeSeason(seasonIndex, "deluxeDetails")}>
              Remove Season
            </button>
          </div>
        ))}

        <button type="button" onClick={() => addSeason("deluxeDetails")}>
          Add Season
        </button>
      </div>
...
{console.log(itinerary.siteSeen)}
  ...
  const renderPremiumDetails = () => (
    <div className="premiumDetails">
      ...
      <div className="formGroup">
        <label>Seasons</label>
        {tourData.premiumDetails?.seasons?.map((season, seasonIndex) => (
          <div key={seasonIndex} className="seasonBlock">
            {/* Season Start & End Date */}
            <input
              type="text"
              value={season.seasonName}
              onChange={(e) => handleSeasonChange(seasonIndex, "seasonName", e.target.value, "premiumDetails")}
              placeholder="Season Name"
            />
            <input
              type="date"
              value={season.startDate}
              onChange={(e) => handleSeasonChange(seasonIndex, "startDate", e.target.value, "premiumDetails")}
              placeholder="Season Start Date"
            />
            <input
              type="date"
              value={season.endDate}
              onChange={(e) => handleSeasonChange(seasonIndex, "endDate", e.target.value, "premiumDetails")}
              placeholder="Season End Date"
            />
            ...
            {season.pricing.map((priceObj, priceIndex) => (
              <div key={priceIndex}>
                <input
                  type="number"
                  value={priceObj.price}
                  onChange={(e) => handlePricingChange(seasonIndex, priceIndex, "price", e.target.value, "premiumDetails")}
                  placeholder="Price per person"
                />
                <input
                  type="number"
                  value={priceObj.rooms}
                  onChange={(e) => handlePricingChange(seasonIndex, priceIndex, "rooms", e.target.value, "premiumDetails")}
                  placeholder="Number of rooms"
                />
                <button
                  type="button"
                  onClick={() => removePricingForSeason(seasonIndex, priceIndex, "premiumDetails")}
                >
                  Remove Pricing
                </button>
              </div>
            ...
            <button type="button" onClick={() => addPricingForSeason(seasonIndex, "premiumDetails")}>
              Add Pricing
            </button>

            <button type="button" onClick={() => removeSeason(seasonIndex, "premiumDetails")}>
              Remove Season
            </button>
          </div>
        ))}

        <button type="button" onClick={() => addSeason("premiumDetails")}>
          Add Season
        </button>
      </div>
      <div className="formGroup">
...
<div className="formGroup">
  ...
  <input
    ...
    value={tourData?.openGraph?.image}
    onChange={handleTagsChange}
...
<div className="formGroup">
  ...
  <input
    type="text"
    name="twitter.cardType"
    value={tourData?.twitter?.cardType}
    onChange={handleChange}
    placeholder="Enter Twitter card type (summary, large_image)"
    required
  />
</div>
