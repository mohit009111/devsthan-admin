            ...
            <div className="formGroup">
                ...
                {tourData.premiumDetails.itineraries.map((itinerary, index) => (
                    <div key={index} className="itinerary">
                        ...
                        {itinerary.welcomeDrinks?.isAvailable && (
                            <div className="siteseen-section">
                                ...
                                <div className="preview-photos">
                                    {itinerary.welcomeDrinks.photos &&
                                        itinerary.welcomeDrinks.photos.map((photo, photoIndex) => (
                                            <img key={photoIndex} src={photo} alt={`welcomeDrinks photo ${photoIndex + 1}`} width="100" />
                                        ))}
                                </div>
                            </div>
                        )}
                        ...
                        {itinerary.siteSeen?.map((siteSeen, siteIndex) => (
                            <div key={siteIndex} className="siteseen-section">
                                <h4>Siteseen Details {siteIndex + 1}</h4>
                                ...
                                <input
                                    ...
                                    value={siteSeen.name || ""}
                                    onChange={(e) => {
                                        const updatedSiteSeen = [...itinerary.siteSeen];
                                        updatedSiteSeen[siteIndex] = { ...siteSeen, name: e.target.value };
                                        handleItineraryChange(index, "siteSeen", updatedSiteSeen, "premiumDetails");
                                    }}
                                />
                                ...
                                <textarea
                                    placeholder="Enter Siteseen description"
                                    value={siteSeen.description || ""}
                                    onChange={(e) => {
                                        const updatedSiteSeen = [...itinerary.siteSeen];
                                        updatedSiteSeen[siteIndex] = { ...siteSeen, description: e.target.value };
                                        handleItineraryChange(index, "siteSeen", updatedSiteSeen, "premiumDetails");
                                    }}
                                ></textarea>
                                ...
                                <input
                                    ...
                                    onChange={(e) => {
                                        const files = Array.from(e.target.files).map((file) => URL.createObjectURL(file));
                                        const updatedSiteSeen = [...itinerary.siteSeen];
                                        updatedSiteSeen[siteIndex] = {
                                            ...siteSeen,
                                            photos: [...(siteSeen.photos || []), ...files],
                                        };
                                        handleItineraryChange(index, "siteSeen", updatedSiteSeen, "premiumDetails");
                                    }}
                                />
                                ...
                                <div className="preview-photos">
                                    {siteSeen.photos &&
                                        siteSeen.photos.map((photo, photoIndex) => (
                                            <img key={photoIndex} src={photo} alt={`Siteseen photo ${photoIndex + 1}`} width="100" />
                                        ))}
                                </div>
                                ...
                                <button
                                    onClick={() => {
                                        const updatedSiteSeen = itinerary.siteSeen.filter((_, i) => i !== siteIndex);
                                        handleItineraryChange(index, "siteSeen", updatedSiteSeen, "premiumDetails");
                                    }}
                                >
                                    Remove Siteseen
                        ...
                        <button
                            onClick={() => {
                                const newSiteSeen = { name: "", description: "", photos: [] };
                                const updatedSiteSeen = [...(itinerary.siteSeen || []), newSiteSeen];
                                handleItineraryChange(index, "siteSeen", updatedSiteSeen, "premiumDetails");
                            }}
                        >
                            Add Siteseen
