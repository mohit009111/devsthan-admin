...
const NewDestination = ({ title }) => {
    ...
    const handleSubmit = async () => {
        ...
        // Check if a value is a Cloudinary URL
        // Check if a value is a Cloudinary URL
        ...
        try {
            // Upload banner image if it exists and is not already uploaded
            ...
            // Upload images array if it exists and contains files not yet uploaded
            ...
            <div className="newContainer">
                ...
                <div className="formContainer">
                    ...
                    <div className="formGroup">
                        ...
                        />
                        <img key={destinationData.bannerImage} src={destinationData.bannerImage} alt={`Preview`} className="previewImg" />
                    </div>
                    <div className="formGroup">
